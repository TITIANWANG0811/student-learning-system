                            ...
                            try:
                                ...
                                conn.execute(text("""
                                    INSERT INTO recitations (
                                        ...
                                        markdown_content, recitation_type, vocabulary_type, grade_level, 
                                        unit_name, difficulty_level, is_memorized, practice_count, 
                                ...
                                """), {
                                    'id': str(uuid.uuid4()),
                                    'student_id': '00000000-0000-0000-0000-000000000000',  # 默认学生ID
